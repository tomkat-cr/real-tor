    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            ...
            'process.env': {
                ...
                REACT_APP_URI_PREFIX: JSON.stringify(process.env.REACT_APP_URI_PREFIX || 'real-tor_frontend'),
                REACT_APP_X_TOKEN: JSON.stringify(process.env.REACT_APP_X_TOKEN || ''),
                REACT_APP_APP_NAME: JSON.stringify(process.env.REACT_APP_APP_NAME || 'real-tor'),
